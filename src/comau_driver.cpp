...
void *assignSetPoint(void*) {
	...
	ros::Subscriber sub = n.subscribe( "lar_comau/comau_joint_state_publisher",1000,jCallback );
	joint_state_pub = n.advertise<sensor_msgs::JointState>("lar_comau/comau_joint_states", 1000);
